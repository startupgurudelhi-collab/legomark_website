...
export const testimonialsDb = [
  {
    ...
    rating: 5,
    content: "Legomark made our Private Limited incorporation completely seamless. From DSC generation to Certificate of Incorporation in just 8 days! High recommended for startups.",
    featured: true,
    sortOrder: 1
  },
  {
    ...
    designation: "Founder",
    company: "Nourish Foods",
    rating: 5,
    content: "Excellent GST return filing service. Their automated monthly purchase reconciliations keep us totally audit-ready with zero late fees.",
    featured: true,
    sortOrder: 2
  }
];
